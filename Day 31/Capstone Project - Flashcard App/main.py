...
wrong_sign_image = PhotoImage(file="images/wrong.png")
wrong_button = Button(image=wrong_sign_image, command=next_card)
wrong_button.grid(row=1, column=0)

right_sign_image = PhotoImage(file="images/right.png")
right_button = Button(image=right_sign_image, command=is_known)
